...
error_reporting();
 ...
 insertado($usuario,$_POST['id'],$_POST['numpregunta'],$_POST['contextualizacion2'],$_POST['pregunta2'],$_POST['opcion1'],
 $_POST['opcion2'],$_POST['opcion3'],$_POST['opcion4'],$_FILES['imagenc'],$_FILES['imagenp']);




  function insertado($usuario,$id,$numpregunta,$Contenido,$Pregunta,$opcion1,$opcion2,$opcion3,$opcion4,$archivo,$archivo2){
...
$con = New Conexion();
 ...
 '".$Pregunta."','".$opcion1."','".$opcion2."','".$opcion3."','".$opcion4."','".$archivo."','".$archivo2."','','','')";
